...
namespace BestSignDemo.Util
{
    ...
    class ConfigLoader
    {
        ...
        public static string inipath = AppDomain.CurrentDomain.BaseDirectory + "../../src/Demo.ini";
 
       static ConfigLoader()
        {
            if (!File.Exists(inipath))
            {
                inipath = AppDomain.CurrentDomain.BaseDirectory + "../../../src/Demo.ini";
            } 

            configs = new Dictionary<string, string>();

            string[] configLines = File.ReadAllLines(inipath);
